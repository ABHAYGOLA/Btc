...
import './App.css';
import coinabi from "./Abi.json";
const rpcEndpoint = "https://sepolia.infura.io/v3/dd77c84801864f11a47ce51b0aaf0e9f"; // Replace with your custom testnet RPC endpoint
const infuraUrl = rpcEndpoint;

const App = () => {
  const standard_adr = "0x479A8Fd3932F425e0010E16D9046CB1e0D23d57C";
